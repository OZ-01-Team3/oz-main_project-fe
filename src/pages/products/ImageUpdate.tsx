...
const ImageUpdate = () => {
  ...
  // 사진등록하는 함수
  const handleSubmitProductImg = async (productId: number) => {
    ...
    try {
      ...
      navigate(`/product-update/${productId}`, { state: prevProductInformation });
    } catch (error) {
  ...
  return (
    <div className="w-[500px] md:w-[400px] sm:w-[400px] mx-auto flex flex-col justify-between items-center h-[calc(100vh-95.99px)]">
      <div className="w-full h-full flex flex-col justify-center items-center">
        ...
        <CommonButton
          onClick={() => handleSubmitProductImg(productId)}
