...
const ProductDetailResDescription = () => {
  return (
    <>
      {productsDetails.map(product => (
        <div className="w-full text-mainBlack" key={product.id}>
          <div className="flex flex-col pr-0 justify-center items-center mt-3 mx-auto">
            ...
            <h1 className="text-3xl font-bold  text-center my-4 w-96 ">{product.title}</h1>
          ...
          <div className="w-[400px] m-auto">
            ...
            <ProductDetailTitle title="브랜드" detail={product.brand} />
            <ProductDetailTitle title="사이즈" detail={product.size} />
            <ProductDetailTitle title="구매시기" detail={product.date} />
            <ProductDetailTitle title="상품상태" detail={product.status} />
            <ProductDetailTitle title="상세설명" detail={product.description} />
          </div>
